...
public class AeotradeJwtAccessTokenConverter extends JwtAccessTokenConverter {
    ...
    private AccessTokenConverter tokenConverter = new AeotradeAccessTokenConverter();
